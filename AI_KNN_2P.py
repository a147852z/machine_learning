...
class MLPlay:
    def __init__(self, ai_name, *args, **kwargs):
        ...
        self.knn = PingPongKNN(model_path='my_game_model.pkl')
        self.knn.load()
    ...
    def update(self, scene_info, *args, **kwargs):
        ...
        if status != "GAME_ALIVE":
            ...
            log_folder = "C:/Users/gslab/Desktop/pingpong1/trainning_2"
        ...
        landing_x = self.knn.predict(ball[0], ball[1], speed[0], speed[1])
...
class PingPongKNN:
    def __init__(self, model_path='my_game_model_NEW_2P.pkl', k=3):
        """
        初始化 KNN 模型管理器
